...
/* Annotate all 'Stub*Repository' classes with @Repository
...
/* Assign the 'jdbc' profile to all Jdbc*Repository classes
...
/* Use "jdbc" and "jndi" as active profiles
...
/* Create an inner static class from TestInfrastructureConfig
