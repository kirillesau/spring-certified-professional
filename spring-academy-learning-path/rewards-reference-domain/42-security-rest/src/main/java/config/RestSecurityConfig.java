...
public class RestSecurityConfig {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        ...
        http.authorizeHttpRequests((authz) -> authz
                // Configure authorization using requestMatchers method
                ...
                //   for all roles - "USER", "ADMIN", "SUPERADMIN"
                        ...
                        .requestMatchers(POST, "/accounts/**").hasAnyRole("SUPERADMIN", "ADMIN")
                        .requestMatchers(PUT, "/accounts/**").hasAnyRole("SUPERADMIN", "ADMIN")
                        .requestMatchers(GET, "/accounts/**").hasAnyRole("SUPERADMIN", "ADMIN", "USER")
                        .requestMatchers(GET, "/authorities").hasAnyRole("SUPERADMIN", "ADMIN", "USER")
    ...
    // Remove the InMemoryUserDetailsManager definition
