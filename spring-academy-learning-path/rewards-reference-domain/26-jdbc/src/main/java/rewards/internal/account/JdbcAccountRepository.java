...
// Inject JdbcTemplate directly to this repository class
...
// Refactor this repository to use JdbcTemplate.
...
public class JdbcAccountRepository implements AccountRepository {
    ...
    // Refactor this method using JdbcTemplate and ResultSetExtractor
    ...
    // Refactor this method to use JdbcTemplate.
    ...
    public void updateBeneficiaries(Account account) {
        ...
        account.getBeneficiaries().forEach(beneficiary -> jdbcTemplate.update(sql, beneficiary.getSavings().asBigDecimal(), account.getEntityId(), beneficiary.getName()));
    }
