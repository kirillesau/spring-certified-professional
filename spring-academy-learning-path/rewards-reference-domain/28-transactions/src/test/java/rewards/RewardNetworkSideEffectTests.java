 ...
 * <p>
 * MAKE SURE to revert the propagation attribute back to
 * REQUIRED in RewardNetworkImpl.
 * <p>
 * Examine the @Test logic below. Note that committed results from the
 ...
 * <p>
 * Add @Transactional on the class and re-run the test. It should pass.
 * Do you know why?
 */
