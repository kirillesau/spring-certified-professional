 ...
 * <p>
 * Open pom.xml or build.gradle for this project and check the dependencies.
 * - Note that we are using Spring Boot starter for Web
 * - Note that we are also using devtools
 * <p>
 * Run the application as a Spring Boot or Java application
...
/**
 * Make this server listen on port 8088.
